    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <h1 className="text-xl font-extrabold text-slate-900">Finance & General Ledger Command Center</h1>
          <p className="text-xs text-slate-500 mt-1 max-w-2xl">Chart of Accounts, double-entry journals, student billing reconciliation, and tax compliance.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-5">
        ...
        <div className="p-8 text-center text-xs text-slate-500">
          Viewing synchronized live operational feed for Finance & General Ledger Command Center. All access events are cryptographically audited.
        </div>
      </div>
    </div>
  );
