    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <h1 className="text-xl font-extrabold text-slate-900">Parent & Guardian Monitoring Portal</h1>
          <p className="text-xs text-slate-500 mt-1 max-w-2xl">Ward academic progress, real-time attendance alerts, fee invoice payments, and faculty communication.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-5">
        ...
        <div className="p-8 text-center text-xs text-slate-500">
          Viewing synchronized live operational feed for Parent & Guardian Monitoring Portal. All access events are cryptographically audited.
        </div>
      </div>
    </div>
  );
