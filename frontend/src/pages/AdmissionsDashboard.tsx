    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <h1 className="text-xl font-extrabold text-slate-900">Admissions CRM & Enrollment Pipeline</h1>
          <p className="text-xs text-slate-500 mt-1 max-w-2xl">Lead tracking, entrance examination scores, merit list generation, and seat allocation.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-5">
        ...
        <div className="p-8 text-center text-xs text-slate-500">
          Viewing synchronized live operational feed for Admissions CRM & Enrollment Pipeline. All access events are cryptographically audited.
        </div>
      </div>
    </div>
  );
