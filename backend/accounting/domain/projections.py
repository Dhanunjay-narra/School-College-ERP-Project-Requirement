"""
Accounts Payable & Receivable — Denormalized Read Projections & Materialized Views.
"""
...
class AccountingSummaryProjection:
    """Optimized read model for executive dashboards and mobile API feeds in Accounts Payable & Receivable."""

    def __init__(self, entity: AccountingEntity):
