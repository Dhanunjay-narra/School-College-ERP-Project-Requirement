"""
Accounts Payable & Receivable — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class AccountingCacheKeys:
    """Standardized Redis key generator for Accounts Payable & Receivable."""

    PREFIX = "erp:accounting"
