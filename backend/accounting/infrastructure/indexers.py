"""
Accounts Payable & Receivable — In-Memory Secondary Indexer.
Enables sub-millisecond lookup by code, status, and tenant in accounting.
"""
from typing import Dict, List, Set, Optional
from backend.accounting.domain.entities import AccountingEntity

class AccountingMemoryIndexer:
    """Secondary index manager for Accounts Payable & Receivable."""
    ...
    def index_entity(self, entity: AccountingEntity):
