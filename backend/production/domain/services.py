"""
Campus Workshop & Fab Lab — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.production.domain_service")

class ProductionDomainService:
    """Encapsulates pure business logic and invariant checks for Campus Workshop & Fab Lab."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for production."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: ProductionEntity) -> float:
