"""
LMS & Assignments — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.assignments.domain_service")

class AssignmentsDomainService:
    """Encapsulates pure business logic and invariant checks for LMS & Assignments."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for assignments."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: AssignmentsEntity) -> float:
