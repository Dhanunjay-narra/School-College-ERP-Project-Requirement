"""
LMS & Assignments — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class AssignmentsCacheKeys:
    """Standardized Redis key generator for LMS & Assignments."""

    PREFIX = "erp:assignments"
