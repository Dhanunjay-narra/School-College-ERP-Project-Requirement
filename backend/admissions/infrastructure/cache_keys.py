"""
Admissions CRM & Merit Engine — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class AdmissionsCacheKeys:
    """Standardized Redis key generator for Admissions CRM & Merit Engine."""

    PREFIX = "erp:admissions"
