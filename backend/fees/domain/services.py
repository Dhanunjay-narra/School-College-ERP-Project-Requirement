"""
Fees & Student Billing — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.fees.domain_service")

class FeesDomainService:
    """Encapsulates pure business logic and invariant checks for Fees & Student Billing."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for fees."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: FeesEntity) -> float:
