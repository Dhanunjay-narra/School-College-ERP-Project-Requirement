"""
Library & RFID Circulation — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.library.domain_service")

class LibraryDomainService:
    """Encapsulates pure business logic and invariant checks for Library & RFID Circulation."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for library."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: LibraryEntity) -> float:
