"""
Academic Structure & Timetable — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class AcademicsCacheKeys:
    """Standardized Redis key generator for Academic Structure & Timetable."""

    PREFIX = "erp:academics"
