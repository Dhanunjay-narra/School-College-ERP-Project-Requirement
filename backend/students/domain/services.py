"""
Student Information & Lifecycle — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.students.domain_service")

class StudentsDomainService:
    """Encapsulates pure business logic and invariant checks for Student Information & Lifecycle."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for students."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: StudentsEntity) -> float:
