"""
Campus Inventory & Stores — Denormalized Read Projections & Materialized Views.
"""
...
class InventorySummaryProjection:
    """Optimized read model for executive dashboards and mobile API feeds in Campus Inventory & Stores."""

    def __init__(self, entity: InventoryEntity):
