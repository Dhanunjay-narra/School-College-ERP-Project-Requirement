"""
Transportation & GPS Fleet — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class TransportCacheKeys:
    """Standardized Redis key generator for Transportation & GPS Fleet."""

    PREFIX = "erp:transport"
