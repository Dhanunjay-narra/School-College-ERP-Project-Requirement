"""
Transportation & GPS Fleet — Formal API Contracts & Validation Specifications.
Defines public API response payloads, header validation, and pagination contracts for transport.
"""
...
class TransportContractRequest(BaseModel):
    """Client mutation contract payload for Transportation & GPS Fleet."""
...
class TransportContractResponse(BaseModel, Generic[T]):
    """Standard unified API envelope for Transportation & GPS Fleet."""
    success: bool = True
    status_code: int = 200
