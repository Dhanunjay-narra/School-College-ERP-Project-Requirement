"""
Transportation & GPS Fleet — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.transport.domain_service")

class TransportDomainService:
    """Encapsulates pure business logic and invariant checks for Transportation & GPS Fleet."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for transport."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: TransportEntity) -> float:
