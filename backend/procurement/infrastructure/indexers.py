"""
Procurement Management — In-Memory Secondary Indexer.
Enables sub-millisecond lookup by code, status, and tenant in procurement.
"""
from typing import Dict, List, Set, Optional
from backend.procurement.domain.entities import ProcurementEntity

class ProcurementMemoryIndexer:
    """Secondary index manager for Procurement Management."""
    ...
    def index_entity(self, entity: ProcurementEntity):
