"""
Procurement Management — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.procurement.domain_service")

class ProcurementDomainService:
    """Encapsulates pure business logic and invariant checks for Procurement Management."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for procurement."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: ProcurementEntity) -> float:
