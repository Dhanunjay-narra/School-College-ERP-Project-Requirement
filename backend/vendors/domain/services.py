"""
Vendor Management & Compliance — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.vendors.domain_service")

class VendorsDomainService:
    """Encapsulates pure business logic and invariant checks for Vendor Management & Compliance."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for vendors."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: VendorsEntity) -> float:
