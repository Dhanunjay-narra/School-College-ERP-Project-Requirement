"""
Vendor Management & Compliance — Anti-Corruption Layer (ACL) Translator.
Translates external entity representations to Vendor Management & Compliance aggregate roots.
"""
from typing import Dict, Any, Optional
from backend.vendors.domain.entities import VendorsEntity

class VendorsACLTranslator:
    """Isolates Vendor Management & Compliance domain from external legacy formats."""

    @classmethod
    def translate_from_external_source(cls, external_data: Dict[str, Any], tenant_id: str = "default_institution") -> VendorsEntity:
