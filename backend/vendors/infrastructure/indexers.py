"""
Vendor Management & Compliance — In-Memory Secondary Indexer.
Enables sub-millisecond lookup by code, status, and tenant in vendors.
"""
from typing import Dict, List, Set, Optional
from backend.vendors.domain.entities import VendorsEntity

class VendorsMemoryIndexer:
    """Secondary index manager for Vendor Management & Compliance."""
    ...
    def index_entity(self, entity: VendorsEntity):
