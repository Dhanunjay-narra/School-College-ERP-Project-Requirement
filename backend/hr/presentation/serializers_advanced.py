"""
Human Resource & Recruitment — Advanced Exporters, PDF & JSON-LD Serialization.
"""
import json
from typing import List, Dict, Any
from backend.hr.domain.entities import HrEntity

class HrAdvancedSerializer:
    @staticmethod
    def to_json_ld(entity: HrEntity) -> Dict[str, Any]:
    ...
    @staticmethod
    def generate_pdf_summary_spec(entity: HrEntity) -> Dict[str, Any]:
        """Generate ReportLab PDF rendering specification dictionary."""
        return {
            "document_title": f"Official Human Resource & Recruitment Record",
            "header": {
                "institution": "Apex Institute of Technology & Management",
                "subsystem": "Human Resource & Recruitment",
