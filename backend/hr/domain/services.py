"""
Human Resource & Recruitment — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.hr.domain_service")

class HrDomainService:
    """Encapsulates pure business logic and invariant checks for Human Resource & Recruitment."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for hr."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: HrEntity) -> float:
