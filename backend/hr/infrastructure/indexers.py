"""
Human Resource & Recruitment — In-Memory Secondary Indexer.
Enables sub-millisecond lookup by code, status, and tenant in hr.
"""
from typing import Dict, List, Set, Optional
from backend.hr.domain.entities import HrEntity

class HrMemoryIndexer:
    """Secondary index manager for Human Resource & Recruitment."""
    ...
    def index_entity(self, entity: HrEntity):
