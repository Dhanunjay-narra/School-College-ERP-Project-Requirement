"""
Applicant Tracking System — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.recruitment.domain_service")

class RecruitmentDomainService:
    """Encapsulates pure business logic and invariant checks for Applicant Tracking System."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for recruitment."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: RecruitmentEntity) -> float:
