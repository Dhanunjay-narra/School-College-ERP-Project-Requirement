"""
Applicant Tracking System — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class RecruitmentCacheKeys:
    """Standardized Redis key generator for Applicant Tracking System."""

    PREFIX = "erp:recruitment"
