"""
Applicant Tracking System — In-Memory Secondary Indexer.
Enables sub-millisecond lookup by code, status, and tenant in recruitment.
"""
from typing import Dict, List, Set, Optional
from backend.recruitment.domain.entities import RecruitmentEntity

class RecruitmentMemoryIndexer:
    """Secondary index manager for Applicant Tracking System."""
    ...
    def index_entity(self, entity: RecruitmentEntity):
