"""
Multi-Store Warehouse Management — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class WarehousesCacheKeys:
    """Standardized Redis key generator for Multi-Store Warehouse Management."""

    PREFIX = "erp:warehouses"
