"""
Organization & Multi-Campus — GraphQL Type Definitions & Resolvers.
Provides federated GraphQL schema mappings for organization.
"""
...
class OrganizationGraphQLType:
    ...
    @classmethod
    def from_entity(cls, entity) -> "OrganizationGraphQLType":
        return cls(
            id=entity.id,
            code=entity.code,
            name=entity.name,
