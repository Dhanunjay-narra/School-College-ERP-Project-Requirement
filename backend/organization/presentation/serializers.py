"""
Organization & Multi-Campus — Serializers, Formatter & Exporters.
Provides CSV, JSON, and XML serialization routines for organization.
"""
import json
import csv
import io
...
class OrganizationSerializer:
    @staticmethod
    def to_json(entity: OrganizationEntity) -> str:
        return json.dumps(entity.to_dict(), indent=2)

    @staticmethod
    def to_csv(entities: List[OrganizationEntity]) -> str:
        output = io.StringIO()
    ...
    @staticmethod
    def to_summary(entity: OrganizationEntity) -> Dict[str, Any]:
        return {
            "id": entity.id,
