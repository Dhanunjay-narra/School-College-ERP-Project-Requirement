"""
Smart Attendance Engine — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class AttendanceCacheKeys:
    """Standardized Redis key generator for Smart Attendance Engine."""

    PREFIX = "erp:attendance"
