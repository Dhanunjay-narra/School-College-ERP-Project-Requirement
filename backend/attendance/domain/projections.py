"""
Smart Attendance Engine — Denormalized Read Projections & Materialized Views.
"""
...
class AttendanceSummaryProjection:
    """Optimized read model for executive dashboards and mobile API feeds in Smart Attendance Engine."""

    def __init__(self, entity: AttendanceEntity):
