"""
Smart Attendance Engine — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.attendance.domain_service")

class AttendanceDomainService:
    """Encapsulates pure business logic and invariant checks for Smart Attendance Engine."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for attendance."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: AttendanceEntity) -> float:
