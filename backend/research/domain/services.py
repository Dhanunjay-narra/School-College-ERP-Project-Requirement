"""
Research & Innovation Management — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.research.domain_service")

class ResearchDomainService:
    """Encapsulates pure business logic and invariant checks for Research & Innovation Management."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for research."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: ResearchEntity) -> float:
