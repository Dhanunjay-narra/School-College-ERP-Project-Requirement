"""
Immutable Audit Logging — Denormalized Read Projections & Materialized Views.
"""
...
class AuditSummaryProjection:
    """Optimized read model for executive dashboards and mobile API feeds in Immutable Audit Logging."""

    def __init__(self, entity: AuditEntity):
