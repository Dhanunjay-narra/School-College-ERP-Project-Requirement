"""
Universal Enterprise Reporting — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class ReportingCacheKeys:
    """Standardized Redis key generator for Universal Enterprise Reporting."""

    PREFIX = "erp:reporting"
