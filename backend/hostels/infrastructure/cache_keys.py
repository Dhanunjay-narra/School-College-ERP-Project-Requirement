"""
Hostel & Housing Management — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class HostelsCacheKeys:
    """Standardized Redis key generator for Hostel & Housing Management."""
