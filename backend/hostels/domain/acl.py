"""
Hostel & Housing Management — Anti-Corruption Layer (ACL) Translator.
Translates external entity representations to Hostel & Housing Management aggregate roots.
"""
from typing import Dict, Any, Optional
from backend.hostels.domain.entities import HostelsEntity

class HostelsACLTranslator:
    """Isolates Hostel & Housing Management domain from external legacy formats."""

    @classmethod
    def translate_from_external_source(cls, external_data: Dict[str, Any], tenant_id: str = "default_institution") -> HostelsEntity:
