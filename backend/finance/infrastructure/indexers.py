"""
Finance & General Ledger — In-Memory Secondary Indexer.
Enables sub-millisecond lookup by code, status, and tenant in finance.
"""
from typing import Dict, List, Set, Optional
from backend.finance.domain.entities import FinanceEntity

class FinanceMemoryIndexer:
    """Secondary index manager for Finance & General Ledger."""
    ...
    def index_entity(self, entity: FinanceEntity):
