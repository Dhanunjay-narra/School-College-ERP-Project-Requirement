"""
Integrated Payroll Engine — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.payroll.domain_service")

class PayrollDomainService:
    """Encapsulates pure business logic and invariant checks for Integrated Payroll Engine."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for payroll."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: PayrollEntity) -> float:
