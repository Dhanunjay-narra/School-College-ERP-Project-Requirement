"""
Parent & Guardian Management — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.parents.domain_service")

class ParentsDomainService:
    """Encapsulates pure business logic and invariant checks for Parent & Guardian Management."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for parents."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: ParentsEntity) -> float:
