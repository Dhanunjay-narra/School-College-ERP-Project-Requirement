"""
Parent & Guardian Management — Anti-Corruption Layer (ACL) Translator.
Translates external entity representations to Parent & Guardian Management aggregate roots.
"""
from typing import Dict, Any, Optional
from backend.parents.domain.entities import ParentsEntity

class ParentsACLTranslator:
    """Isolates Parent & Guardian Management domain from external legacy formats."""

    @classmethod
    def translate_from_external_source(cls, external_data: Dict[str, Any], tenant_id: str = "default_institution") -> ParentsEntity:
