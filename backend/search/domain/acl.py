"""
Centralized Faceted Search — Anti-Corruption Layer (ACL) Translator.
Translates external entity representations to Centralized Faceted Search aggregate roots.
"""
from typing import Dict, Any, Optional
from backend.search.domain.entities import SearchEntity

class SearchACLTranslator:
    """Isolates Centralized Faceted Search domain from external legacy formats."""

    @classmethod
    def translate_from_external_source(cls, external_data: Dict[str, Any], tenant_id: str = "default_institution") -> SearchEntity:
        return SearchEntity(
