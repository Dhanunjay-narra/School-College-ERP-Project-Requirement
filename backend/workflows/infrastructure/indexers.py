"""
Configurable Workflow Engine — In-Memory Secondary Indexer.
Enables sub-millisecond lookup by code, status, and tenant in workflows.
"""
from typing import Dict, List, Set, Optional
from backend.workflows.domain.entities import WorkflowsEntity

class WorkflowsMemoryIndexer:
    """Secondary index manager for Configurable Workflow Engine."""
    ...
    def index_entity(self, entity: WorkflowsEntity):
