"""
Configurable Workflow Engine — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class WorkflowsCacheKeys:
    """Standardized Redis key generator for Configurable Workflow Engine."""

    PREFIX = "erp:workflows"
