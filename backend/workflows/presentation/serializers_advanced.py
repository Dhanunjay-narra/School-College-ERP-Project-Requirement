"""
Configurable Workflow Engine — Advanced Exporters, PDF & JSON-LD Serialization.
"""
import json
from typing import List, Dict, Any
from backend.workflows.domain.entities import WorkflowsEntity

class WorkflowsAdvancedSerializer:
    @staticmethod
    def to_json_ld(entity: WorkflowsEntity) -> Dict[str, Any]:
        ...
        return {
            ...
            "@type": "Workflows",
            "@id": f"urn:erp:workflows:{entity.id}",
    ...
    @staticmethod
    def generate_pdf_summary_spec(entity: WorkflowsEntity) -> Dict[str, Any]:
        """Generate ReportLab PDF rendering specification dictionary."""
        return {
            "document_title": f"Official Configurable Workflow Engine Record",
            "header": {
                "institution": "Apex Institute of Technology & Management",
                "subsystem": "Configurable Workflow Engine",
