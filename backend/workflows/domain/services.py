"""
Configurable Workflow Engine — Domain Business Rules & Invariant Validation Service.
"""
import logging
...
logger = logging.getLogger("erp.workflows.domain_service")

class WorkflowsDomainService:
    """Encapsulates pure business logic and invariant checks for Configurable Workflow Engine."""
    ...
    def assert_valid_state_transition(current_status: str, new_status: str):
        """State machine invariant validation for workflows."""
        valid_transitions = {
    ...
    @staticmethod
    def calculate_operational_health_score(entity: WorkflowsEntity) -> float:
