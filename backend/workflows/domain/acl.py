"""
Configurable Workflow Engine — Anti-Corruption Layer (ACL) Translator.
Translates external entity representations to Configurable Workflow Engine aggregate roots.
"""
from typing import Dict, Any, Optional
from backend.workflows.domain.entities import WorkflowsEntity

class WorkflowsACLTranslator:
    """Isolates Configurable Workflow Engine domain from external legacy formats."""

    @classmethod
    def translate_from_external_source(cls, external_data: Dict[str, Any], tenant_id: str = "default_institution") -> WorkflowsEntity:
