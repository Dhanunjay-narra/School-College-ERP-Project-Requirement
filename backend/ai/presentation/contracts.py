"""
AI/ML Predictive Intelligence — Formal API Contracts & Validation Specifications.
Defines public API response payloads, header validation, and pagination contracts for ai.
"""
...
class AiContractRequest(BaseModel):
    """Client mutation contract payload for AI/ML Predictive Intelligence."""
...
class AiContractResponse(BaseModel, Generic[T]):
    """Standard unified API envelope for AI/ML Predictive Intelligence."""
    success: bool = True
    status_code: int = 200
