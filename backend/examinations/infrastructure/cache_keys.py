"""
Examinations & Grading — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class ExaminationsCacheKeys:
    """Standardized Redis key generator for Examinations & Grading."""

    PREFIX = "erp:examinations"
