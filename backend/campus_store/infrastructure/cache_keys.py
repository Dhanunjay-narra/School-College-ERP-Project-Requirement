"""
Campus Store & Cafeteria POS — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class CampusStoreCacheKeys:
    """Standardized Redis key generator for Campus Store & Cafeteria POS."""

    PREFIX = "erp:campus_store"
