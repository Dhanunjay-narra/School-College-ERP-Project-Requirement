"""
Document Management & Signatures — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class DocumentsCacheKeys:
    """Standardized Redis key generator for Document Management & Signatures."""

    PREFIX = "erp:documents"
