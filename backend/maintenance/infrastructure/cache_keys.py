"""
Campus Facility Maintenance — Redis Cache Key Formatters & Invalidation Policies.
"""
from typing import Optional

class MaintenanceCacheKeys:
    """Standardized Redis key generator for Campus Facility Maintenance."""

    PREFIX = "erp:maintenance"
